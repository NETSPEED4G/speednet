        ...
        <div class="profile-image-wrapper">
          <div class="profile-image">
            <div class="avatar-content">
              <img src="https://tinypic.host/images/2023/02/03/LOGO-OFICIAL-NETSPEED4G.png" alt="some text" width=450 height=350>
            </div>
          </div>
        </div>
          ...
          <a href="home.php?page=usuario/adicionar">
            <div class="card-header d-flex flex-column align-items-center pb-0">
              <div class="avatar bg-light-info avatar-xl">
                <div class="avatar-content">
                 <img src="https://tinypic.host/images/2023/01/31/236822.png">
      ...
      <div class="card border-primary">
        <a href="home.php?page=ssh/contas">
          <div class="card-header d-flex flex-column align-items-center pb-0">
            <div class="avatar bg-light-success avatar-xl">
              <div class="avatar-content">
                <img src="https://tinypic.host/images/2023/01/31/5065003.png">
              </div>
            </div>
        ...
        <div class="card border-primary">
          <a href="home.php?page=subrevenda/revendedores">
            <div class="card-header d-flex flex-column align-items-center pb-0">
              <div class="avatar bg-light-info avatar-xl">
                <div class="avatar-content">
                  <img src="https://tinypic.host/images/2023/01/31/1802743.png">
                </div>
              </div>
