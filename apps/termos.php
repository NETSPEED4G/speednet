...
<html lang="pt-br">
    ...
    <body style="
        ...
        <img src="./img/termos.png" style="height:140px;">
            ...
            <p class="copyright">&copy; 2021 - <script> document.write(new Date().getFullYear())</script><br> Todos os direitos reservados<br><a title="Styleshout" href="https://kiwify.app/NKl55g5">NetSpeed4G 🚀</a></p>
    </body>
</html>
