...
<head>
    ...
    <meta name="keywords" content="VPN GNetSpeed4G 🚀, VPN, SSH, Gratis, Registrar">
    <meta name="author" content="Crazy">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta name="theme-color" content="#FFFFFF">
    <title>NetSpeed4G 🚀 - PAINEL</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="false">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="home.php"><span class="brand-logo">
                            <img class="round" src="https://tinypic.host/images/2023/02/03/lancamento-do-foguete-1.png" alt="avatar" height="35" width="28" />
                        </span>
                        <h2 class="brand-text">NetSpeed4G </h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a class="d-flex align-items-center" href="home.php"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">INICIO</span></a></li>
...
<A>
<A>
                <li class="active"><a class="d-flex align-items-center" href="?page=img/downloads"><i data-feather="download"></i><span class="menu-title text-truncate" data-i18n="Dashboards">MATERIAIS</span></a></li>
        ...
        <center>
            <p class="clearfix blue-grey lighten-2 mb-0">
                <span class="center">
                    ...
                    <a class="text-bold-800 grey darken-2" href="" target="_blank">NetSpeed4G 🚀</a></span>
                </span>
